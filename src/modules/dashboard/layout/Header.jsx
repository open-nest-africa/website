      ...
      <div className="flex items-center gap-x-3">
        ...
        <span className="h-10 w-10 rounded-full">
          {imageError || !githubAvatar ? (
            <div className="relative w-11 h-11 cursor-pointer transform transition-all duration-300 ease-in-out hover:scale-105">
            ...
            <div className="relative w-11 h-11 cursor-pointer transition-all duration-300 ease-in-out hover:scale-105">
              <img
                src={githubAvatar}
                alt="User Avatar"
