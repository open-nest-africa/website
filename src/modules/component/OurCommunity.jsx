  ...
  return (
    <section className="flex flex-col lg:flex-row items-center gap-y-10 lg:gap-x-[30px] py-10 sm:py-16 lg:py-20 px-4 sm:px-8 md:px-16 lg:pl-24">
      <aside className="w-full lg:w-1/2 text-center lg:text-left">
        <h2 className="text-black dark:text-white text-3xl sm:text-4xl md:text-5xl lg:text-[64px] leading-snug lg:leading-[92.8px] font-semibold">
          Our Community
        </h2>
        <p className="text-[#04354A] dark:text-[#A4DDEE] tracking-normal sm:-tracking-[0.5px] md:-tracking-[1px] text-base sm:text-lg md:text-xl lg:text-2xl mt-4">
