...
const WhyOpenNest = () => {
  return (
    <section className="px-4 sm:px-6 md:px-10 lg:px-16 xl:px-[100px] py-10 sm:py-12 md:py-14">
      <h1 className="text-black text-3xl sm:text-4xl md:text-5xl lg:text-[64px] leading-tight lg:leading-[92.8px] font-semibold text-center">
        Why Choose OpenNest
      </h1>
