...
const Footer = () => {
  ...
  return (
    <section className="bg-primary p-6 flex flex-col lg:flex-row gap-6">
      ...
      <aside className="bg-[#AEDFF4] rounded-[20px] w-full lg:w-2/3 h-auto lg:h-[380px] p-6 md:p-9 flex flex-col gap-6 md:gap-8">
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`p-3 rounded-full bg-[#3E3838] text-white transition-all duration-300 transform hover:scale-110 ${social.bgColor}`}
          ...
          <div className="flex flex-col sm:flex-row sm:justify-start space-y-2 sm:space-y-0 sm:space-x-8 text-[#514A4A] text-sm font-semibold border-t border-[#8D8484]/20 pt-4">
            <Link
              to="/privacy-policy"
              className="hover:text-blue-600 transition-colors duration-200"
            >
